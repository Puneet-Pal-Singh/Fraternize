      ...
      <div style={{ maxWidth: "550px", margin: "0px auto" }}>
        ...
        >
          ...
          <div>
            ...
            <h5 className="brand-logo" style={{ fontSize: "28px" }}>
            ...
            >
              <h6 className="brand-logo" style={{ fontSize: "28px" }}>
                {pic ? pic.length : "0"} Posts
              </h6>
              <h6 className="brand-logo" style={{ fontSize: "28px" }}>
    ...
    renderItem = (
      <div style={{ maxWidth: "550px", margin: "0px auto" }}>
        ...
        >
          ...
          <div>
            <h4 className="brand-logo" style={{ fontSize: "28px" }}>
        ...
        <div className="gallery home1">
          {pic.map((item) => {
            ...
            return (
              <div className="row">
                <div>
                  {item.photo.split("/")[7].split(".")[1] == "mp4" ? (
                    <iframe
                      src={item.photo}
                      alt={item.title}
                      key={item._id}
