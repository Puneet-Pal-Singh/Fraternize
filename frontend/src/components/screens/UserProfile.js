        ...
        <div style={{
            ...
            <h4 className="brand-logo" style={{fontSize:"28px"}}>{userProfile.user.email}</h4>
                <div style={{display:'flex',justifyContent:"space-between",width:"108%"}}>
                    ...
                    <h6 className="brand-logo" style={{fontSize:"28px"}}>{userProfile.user.followers.length} Followers</h6>
                    <h6 className="brand-logo" style={{fontSize:"28px"}}>{userProfile.user.following.length} Following</h6>
                    {showFollow
                    ?
